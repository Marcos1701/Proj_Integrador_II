...
COPY "public"."usuario" ("id", "nome", "saldo", "email", "senha") FROM stdin;
\.
...
COPY "public"."categoria" ("id", "id_usuario", "nome", "descricao") FROM stdin;
\.
...
COPY "public"."meta" ("id", "id_usuario", "valor_desejado", "datafinal", "progresso", "valor_obtido") FROM stdin;
\.


--
-- Data for Name: marco; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY "public"."marco" ("id", "id_meta", "data", "valor_obtido") FROM stdin;
\.
...
COPY "public"."orcamento" ("id", "id_usuario", "id_categoria", "limite") FROM stdin;
\.


--
-- Data for Name: submeta; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY "public"."submeta" ("id", "id_meta", "nome", "descricao", "valor_desejavel", "valor_obtido") FROM stdin;
\.
...
COPY "public"."transacao" ("id", "id_usuario", "id_categoria", "tipo", "valor", "titulo", "descricao", "data") FROM stdin;
\.
