              ...
              <nav className="App-sidebar">
                ...
                <div className="App-sidebar-footer">
                  ...
                  <ul className={"options_perfil" + (showOptions ? "-active" : "")}>
                    ...
                    <li key="logout">
                      <button className='logout-button' type="button" onClick={() => setShowOptions(false)}>Sair</button>
                    </li>
                  </ul>
                </div>
              </nav>
